...
//     public void dfs(int i, int parent, int steps[], int lowSteps[],
//                     List<List<Integer>> adj, List<List<Integer>> ret) {

//         steps[i] = lowSteps[i] = ++step;
...
//                 if (lowSteps[el] > steps[i]) {
//                     ret.add(new ArrayList<>(
//                         List.of(Math.min(i, el), Math.max(i, el))
//                     ));
//                 }

//             } else {

//                 lowSteps[i] = Math.min(lowSteps[i], steps[el]);
...
//             if (steps[i] == 0)
//                 dfs(i, -1, steps, lowSteps, adj, ret);
//         }
